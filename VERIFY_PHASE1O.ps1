...
$expected = @{
    "src\preview_renderer.cpp" = "659bb17c0c38ac57f889adc54b726d13c45ee18c8affad7148b556bfdd640fcd"
...
Write-Host "Phase 1o verification: PASS" -ForegroundColor Green
Write-Host "Captured APE sky yaw, BO3 gloss width, probe LOD, EnvBRDF LUT, sun shadow and filmic display wiring are installed." -ForegroundColor Cyan
